...
<script lang="ts">
    import { contractAddress } from "$lib/contract-info";
            	...
            	<div class="bnr-cnt" >
                	<div class="row">
                    	<div class="col-lg-6 animatedParent animateOnce" data-sequence="250">
                            ...
                            <!--End bnr-head-->
                            <!--ico-countdown-->
                            <div class="ico-countdown text-center px-5 py-4 my-5 animated fadeInUpShort" data-id="2">
                            	<h4>ICO Ends in</h4>
    ...
    <div class="container">
        <div class="animatedParent animateOnce"> 
            ...
            <div class="service-des py-1 animated fadeInUpShort delay-250">
                <p> CryptICO is a platform that allows any indivaidual, charity or NGO to launch their own fundraising campaigns. These campaigns run on Ethereum Smart Contracts and are fully manageable from the Dashboard.</p>
            </div>
        </div>
